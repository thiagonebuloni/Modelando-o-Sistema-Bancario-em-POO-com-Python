...
class Conta:
    ...
    def sacar(self, valor):
        ...
        if excedeu_saldo:
            print("\n@@@ Operação falhou! Vocẽ não tem saldo suficiente. @@@")
...
def exibir_extrato(clientes):
    ...
    extrato = ""
    if not transacoes:
        extrato = "Não foram relizadas movimentações."
    else:
...
def criar_conta(numero_conta, clientes, contas):
    ...
    if not cliente:
        print("\n@@@ Cliente não encotrado, fluxo de criação de conta encerrado! @@@")
        return
